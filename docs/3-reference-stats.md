...
grep -v "^>" Homo\_sapiens.GRCh38.dna.chromosome.21.fa | tr -d '\\n' | wc -c
...
awk '$3 == "gene"' Homo\_sapiens.GRCh38.110.chr21.gtf | wc -l
...
awk '$3 == "transcript"' Homo\_sapiens.GRCh38.110.chr21.gtf | wc -l
...
grep -v "^>" transcriptome\_chr21.fa | tr -d '\\n' | wc -c
